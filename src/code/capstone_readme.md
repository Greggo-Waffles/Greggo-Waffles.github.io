...
{% image "./src/code/ETimages/Screenshot 2025-11-17 025229.png", "Image Firebase set-up" %}<br>
{% image "./src/code/ETimages/Screenshot 2025-11-17 010300.png", "Image of Location Search" %}
{% image "./src/code/ETimages/Screenshot 2025-11-17 020341.png", "Image of date picker" %}
{% image "./src/code/ETimages/Screenshot 2025-11-17 020417.png", "Image of time picker" %}<br><br>
...
{% image "./src/code/ETimages/Screenshot 2025-11-30 151110.png", "Image of the events after the title sort button was clicked" %}<br>
{% image "./src/code/ETimages/Screenshot 2025-11-30 233742.png", "Image of force notification buttons" %}<br>
{% image "./src/code/ETimages/Screenshot 2025-11-30 150030.png", "Image of notification" %}<br><br>
...
{% image "./src/code/ETimages/image_2025-12-15_235157891.png", "Image of group entry" %}
{% image "./src/code/ETimages/image_2025-12-16_155932982.png", "Image of group entry" %}
